  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
      <div className="bg-card/60 w-full max-w-5xl max-h-[90vh] rounded-3xl border border-white/5 shadow-2xl flex flex-col overflow-hidden backdrop-blur-2xl">
        {/* Header */}
        <div className="p-6 border-b border-white/5 flex items-center justify-between bg-card/5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <Badge className="bg-card/5 text-[#64748b] border-none text-[10px] uppercase font-black tracking-widest px-1.5 h-4.5">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button 
              ...
              size="icon" 
              onClick={onClose}
              className="h-10 w-10 text-muted-foreground hover:text-white hover:bg-card/5 rounded-full"
            >
              <X className="h-5 w-5" />
            </Button>
          </div>
        ...
        <div className="flex-1 flex overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-6">
                <div>
                  ...
                  <Input 
                    ...
                    className="bg-card/5 border-white/5 h-12 rounded-xl focus:ring-primary/20"
                  />
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input 
                      ...
                      className="bg-card/5 border-white/5 h-12 px-10 rounded-xl"
                    />
                  </div>
                </div>
                <div>
                  ...
                  >
                    <SelectTrigger className="bg-card/5 border-white/5 h-12 rounded-xl">
                      <SelectValue />
                    </SelectTrigger>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Input 
                    ...
                    className="bg-card/5 border-white/5 h-12 rounded-xl"
                  />
                </div>
                <div>
                    ...
                    <button
                      ...
                      className={`px-3 py-2 rounded-xl border text-xs font-bold transition-all flex items-center gap-2 ${
                        editData.assegnato_a_id === u.id 
                          ...
                          : 'bg-card/5 border-white/5 text-[#64748b] hover:bg-card/10'
                      }`}
                    >
              ...
              <div className="col-span-2">
                ...
                <Textarea 
                  ...
                  className="bg-card/5 border-white/5 min-h-[120px] rounded-2xl resize-none"
          ...
          <div className="w-[380px] bg-card/5 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6 scrollbar-hide">
              <div className="space-y-6">
                {/* Add New Activity */}
                <div className="p-4 bg-card/5 border border-white/5 rounded-2xl space-y-4">
                      ...
                      <button
                        ...
                        className={`px-2 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all ${
                          newActivity.tipo === t 
                            ...
                            : 'bg-card/5 text-[#475569] hover:bg-card/10'
                        }`}
                      >
                        {t}
                      </button>
                ...
                <div className="space-y-6">
                  {lead.attivita?.sort((a,b) => new Date(b.created_at).getTime() - new Date(a.created_at).getTime()).map((act, i) => (
                    <div key={i} className="relative pl-6 before:absolute before:left-0 before:top-2 before:bottom-[-24px] before:w-[1px] before:bg-card/10 last:before:hidden">
                      ...
                      <div className="mt-2 flex items-center gap-2 text-[10px] text-[#64748b]">
                        <div className="h-4 w-4 rounded-full bg-card/5 flex items-center justify-center text-[6px]">
                  ...
                  {(!lead.attivita || lead.attivita.length === 0) && (
                    <div className="text-center py-12">
                      <div className="h-12 w-12 rounded-full bg-card/5 flex items-center justify-center mx-auto mb-4">
