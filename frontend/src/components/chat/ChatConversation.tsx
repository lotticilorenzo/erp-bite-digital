...
export function ChatConversation({ channelId, className }: ChatConversationProps) {
  ...
  if (isInitialLoading) {
    return (
      <div className={cn("flex-1 flex flex-col items-center justify-center gap-4 text-muted-foreground", className)}>
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.2em]">Sincronizzazione messaggi...</p>
      </div>
    );
  }
  ...
  return (
    <div className={cn("flex-1 flex flex-col min-w-0 bg-background/5 relative overflow-hidden", className)}>
      ...
      >
        <div className="max-w-4xl mx-auto w-full px-4 pt-10 pb-6">
          {hasMore && (
          ...
          {allMessages.length === 0 ? (
            <div className="flex flex-col items-center justify-center opacity-20 py-32 animate-in fade-in duration-700">
