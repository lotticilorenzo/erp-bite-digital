...
import { useNotifications, type NotificationNode } from "@/hooks/useNotifications";
...
export function NotificationDropdown() {
  ...
  const handleNotificationClick = (n: NotificationNode) => {
    markAsRead(n.id);
...
function NotificationList({
  ...
  onClick: (n: NotificationNode) => void;
